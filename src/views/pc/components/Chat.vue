<template>
  <div class="chat" :class="$store.state.mode === 'light' ? 'light' : ''">
    <div class="fold" @click="fold">
      <i class="el-icon-s-fold" v-if="!$store.state.fold"></i>
    ...
    <div class="chat-content">
      ...
      <div class="send-message-wrap">
        <div class="textarea-wrap">
          <textarea v-model="question" placeholder="请输入您想要查询的内容" @keydown.enter.prevent="send" class="scrollbar"></textarea>
...
export default {
  ...
  methods: {
    ...
    fold() {
      this.$store.commit('updateFold', !this.$store.state.fold)
    }
  },
  beforeDestroy() {
    this.timer && clearInterval(this.timer)
